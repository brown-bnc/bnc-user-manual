...
<figure><img src="../../.gitbook/assets/voxalign_overlap.png" alt="Voxalign multi-session voxel placement results. Light blue is the session 1 voxel and the dark blue outline is the session 2 voxel outline."><figcaption><p>Voxalign multi-session voxel placement results. Light blue is the session 1 voxel and the dark blue outline is the session 2 voxel outline.</p></figcaption></figure>
